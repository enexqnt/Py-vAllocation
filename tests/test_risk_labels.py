...
def _basic_wrapper_with_scenarios(T: int = 200, N: int = 4) -> PortfolioWrapper:
    ...
    return PortfolioWrapper.from_scenarios(
        scenarios, constraints={"long_only": True, "total_weight": 1.0}
    )
...
def test_risk_percentile_selection_matches_index():
    ...
    w, _, _ = frontier.at_percentile(0.5, risk_label="Volatility")
